...
export const PlayerPage: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen flex flex-col ${theme === 'dark' ? 'bg-gray-900' : 'bg-[#e8ecf1]'} pb-safe-bottom`}>
      <div className={`sticky top-0 z-20 px-4 py-3 flex items-center justify-between backdrop-blur-md border-b ${
        theme === 'dark' 
          ? 'bg-gray-900/95 border-gray-800' 
          : 'bg-[#e8ecf1]/95 border-gray-200/50'
      }`}>
        <button
          onClick={() => navigate('/')}
      ...
      <div className={`relative flex-shrink-0 w-full ${isLoading ? "opacity-0" : "opacity-100"} transition-opacity duration-300`}>
